...
public class PlayerEvents implements Listener {
    ...
    public void onPlayerJoin(PlayerJoinEvent e) {
        ...
        player.getScheduler().runDelayed(plugin, task -> {
            if (player.isOnline() && plugin.getLocator() != null) {
                plugin.getLocator().updatePlayer(player);
            }
        }, null, 15L);
    ...
    public void onEntityDamageByEntity(EntityDamageByEntityEvent e) {
        ...
        if (!WorldGuardHook.isFriendlyFireAllowed(damaged, damaged.getLocation())) return;
    ...
    public void onPlayerDeath(PlayerDeathEvent e) {
        ...
        if (!WorldGuardHook.isXpAllowed(killed, killed.getLocation())) return;
    ...
    public void onEntityDeath(EntityDeathEvent e) {
        ...
        if (!WorldGuardHook.isXpAllowed(killer, killer.getLocation())) return;
    ...
    public void onMythicMobDeath(MythicMobDeathEvent e) {
        ...
        if (!WorldGuardHook.isXpAllowed(player, player.getLocation())) return;
    ...
    public void onPlayerQuit(PlayerQuitEvent e) {
        if (plugin.getLocator() != null) {
            plugin.getLocator().onPlayerQuit(e.getPlayer());
        }
    }
